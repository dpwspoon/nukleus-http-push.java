 ...
 * under the License.
 */
package org.reaktivity.nukleus.http.push.internal.bench;
...
import org.reaktivity.nukleus.http.push.internal.HttpPushController;
import org.reaktivity.nukleus.http.push.internal.HttpPushStreams;
...
public class HttpPushServerBM
{
...

    {
        ...
        reaktor = Reaktor.launch(configuration, n -> "http-push".equals(n), HttpPushController.class::isAssignableFrom);
    }
